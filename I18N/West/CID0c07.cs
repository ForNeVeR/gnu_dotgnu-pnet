...
public class CID0c07 : CID0007
{
	...
	public override DateTimeFormatInfo DateTimeFormat
	{
		get
		{
			...
			dfi.AbbreviatedMonthNames = new String[] {"J\u00E4n", "Feb", "M\u00E4r", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez", ""};
			dfi.MonthNames = new String[] {"J\u00E4nner", "Februar", "M\u00E4rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember", ""};
			dfi.DateSeparator = ".";
			dfi.TimeSeparator = ":";
			...
			dfi.FullDateTimePattern = "dddd, dd. MMMM yyyy HH:mm' Uhr 'z";
#if !ECMA_COMPAT
