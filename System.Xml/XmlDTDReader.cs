/*
 * XmlDTDInternalSubsetReader.cs - Implementation of the
 *			"System.Xml.XmlDTDInternalSubsetReader" class.
 *
...
internal sealed class XmlDTDReader : XmlErrorProcessor
{
...
#if !ECMA_COMPAT
	//public SomeDTDRuleHandlingObjectGoesHere FooBar
	//		{
	//			get {  }
	//			set {  }
	//		}
	...
	// Get the value of the dtd internal subset.
	public String Value
			{
				get { return value; }
			}
	...
	public void Init
				 ...
				 XmlNameTable nameTable)
			{
				...
				this.input = new XmlDTDParserInput(input, nameTable);
	...
	public void Read()
			{
				...
				if(input.peekChar == '[')
				{
					...
					value = input.Logger.Pop().ToString();
