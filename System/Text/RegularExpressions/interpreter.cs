...
namespace System.Text.RegularExpressions {
	...
	class Interpreter : IMachine {
		...
		private void Backtrack (int cp) {
			// #if PNET -- this assertion is incorrect and will fail
			// on perfectly legitimate regexes.  The assertion doesn't
			// typically fire on Mono because the "Conditional" attribute
			// removes the call to Debug.Assert, and everything works fine.
