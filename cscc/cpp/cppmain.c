...
static void cb_def_using PARAMS ((cpp_reader *, unsigned int,
                                  const cpp_token *));
...
/* Copy the contents of a #using directive to the preprocessed output.  */
static void
cb_def_using (pfile, line, token)
     cpp_reader *pfile ATTRIBUTE_UNUSED;
     unsigned int line;
     const cpp_token * token;
{
