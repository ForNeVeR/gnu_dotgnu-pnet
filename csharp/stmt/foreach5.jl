...
.class private sequential value sealed serializable ansi 'TestEnumerable' extends ['.library']'System'.'ValueType' implements 'System.Collections'.'IEnumerable'
{
...
{
.method private hidebysig instance int32 'm1'(valuetype 'TestEnumerable' 'en') cil managed java 
{
	ldc	""
...
?L1:
	aload	4
	invokevirtual	instance bool 'TestEnumerator'::'MoveNext'()
	ifne	?L2
?L3:
	jsr	?L4
	goto	?L5
