...
extern System_Array * _IL_Assembly_GetModules(ILExecThread * _thread, ILObject * _this, ILBool _p1);
...
extern ILInt64 _IL_SignatureHelper_ClrSigFinalize(ILExecThread * _thread, ILNativeInt _p1, ILNativeInt _p2, ILBool _p3);
extern System_Array * _IL_SignatureHelper_ClrSigGetBytes(ILExecThread * _thread, ILNativeInt _p1, ILInt64 _p2);
...
extern ILNativeInt _IL_Process_GetMainWindowHandle(ILExecThread * _thread, ILInt32 _p1);
