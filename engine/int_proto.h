...
extern ILNativeInt _IL_Marshal_OffsetOf(ILExecThread * _thread, ILObject * t, ILString * fieldName);
extern ILString * _IL_Marshal_PtrToStringAnsi_j(ILExecThread * _thread, ILNativeInt ptr);
extern ILString * _IL_Marshal_PtrToStringAnsi_ji(ILExecThread * _thread, ILNativeInt ptr, ILInt32 len);
...
extern ILInt32 _IL_Marshal_SizeOf(ILExecThread * _thread, ILObject * t);
...
extern void _IL_Marshal_PtrToStructureInternal(ILExecThread * _thread, ILNativeInt ptr, ILObject * structure);
...
extern ILString * _IL_InfoMethods_GetSpecialFolder(ILExecThread * _thread, ILInt32 f);
