/*
 * SysCharInfo.cs - Implementation of the "Platform.SysCharInfo" class.
 *
...
{
	// Get the Unicode category for a specific character.
	...
	[MethodImpl(MethodImplOptions.InternalCall)]
	extern public static String GetNewLine();
