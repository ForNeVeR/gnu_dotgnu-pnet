/*
 * SHA512Managed.cs - Implementation of the
 *		"System.Security.Cryptography.SHA512Managed" class.
 *
...
// configured without SHA512 on smaller platforms.
...
public class SHA512Managed : SHA512
{
	...
	public SHA512Managed()
			: base()
			{
				try
				{
					state = CryptoMethods.HashNew(CryptoMethods.SHA512);
				}
				catch(NotImplementedException)
				{
					// The runtime engine does not have SHA512 support.
					throw new CryptographicException
						(_("Crypto_NoProvider"), "SHA512");
				}
			}
